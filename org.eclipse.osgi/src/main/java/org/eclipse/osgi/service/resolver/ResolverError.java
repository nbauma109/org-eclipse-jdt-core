...
public interface ResolverError {
	 ...
	 * @see ResolverError#getType()
	 */
    int SINGLETON_SELECTION = 0x0008;
	/**
	 ...
	 * @see ResolverError#getType()
	 */
    int FRAGMENT_CONFLICT = 0x0010;
	/**
	 * Error type constant (bit mask) indicating that an Import-Package could
	 * not be resolved because of a uses directive conflict.
	 * @see ResolverError#getType()
	 */
    int IMPORT_PACKAGE_USES_CONFLICT = 0x0020;
	/**
	 * Error type constant (bit mask) indicating that a Require-Bundle could
	 * not be resolved because of a uses directive conflict.
	 * @see ResolverError#getType()
	 */
    int REQUIRE_BUNDLE_USES_CONFLICT = 0x0040;
	/**
	 * Error type constant (bit mask) indicating that an Import-Package could
	 ...
	 * @see ResolverError#getType()
	 */
    int IMPORT_PACKAGE_PERMISSION = 0x0080;
	/**
	 * Error type constant (bit mask) indicating that an Import-Package could
	 ...
	 * @see ResolverError#getType()
	 */
    int EXPORT_PACKAGE_PERMISSION = 0x0100;
	/**
	 * Error type constant (bit mask) indicating that a Require-Bundle could
	 ...
	 * @see ResolverError#getType()
	 */
    int REQUIRE_BUNDLE_PERMISSION = 0x0200;
	/**
	 * Error type constant (bit mask) indicating that a Require-Bundle could
	 ...
	 * @see ResolverError#getType()
	 */
    int PROVIDE_BUNDLE_PERMISSION = 0x0400;
	/**
	 * Error type constant (bit mask) indicating that a Fragment-Host could
	 * not be resolved because no bundle with the required symbolic name has
	 ...
	 * @see ResolverError#getType()
	 */
    int HOST_BUNDLE_PERMISSION = 0x0800;
	/**
	 * Error type constant (bit mask) indicating that a Fragment-Host could
	 ...
	 * @see ResolverError#getType()
	 */
    int FRAGMENT_BUNDLE_PERMISSION = 0x1000;
	/**
	 ...
	 * @see ResolverError#getType()
	 */
    int MISSING_EXECUTION_ENVIRONMENT = 0x4000;

	/**
	 * Error type constant (bit mask) indicating that a bundle could not be
	 * resolved because the required generic capability could not be resolved.
	 */
    int MISSING_GENERIC_CAPABILITY = 0x8000;
	 ...
	 * @since 3.4
	 */
    int NO_NATIVECODE_MATCH = 0x10000;
	 ...
	 * @since 3.4
	 */
    int INVALID_NATIVECODE_PATHS = 0x20000;
	 ...
	 * @since 3.7
	 */
    int REQUIRE_CAPABILITY_PERMISSION = 0x80000;
	 ...
	 * @since 3.7
	 */
    int PROVIDE_CAPABILITY_PERMISSION = 0x100000;
